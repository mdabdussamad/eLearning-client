...
const CourseContentList:FC<Props> = (props) => {
  ...
  return (
    <div className={`mt-[15px] w-full ${!props.isDemo && 'mi-[-30px] sticky top-24 left-0 z-30'}`}>
        {videoSections.map((section: string, sectionIndex: number)=>{
            const isSectionVisible = visibleSections.has(section);

            // Filtter videos by section
            ...
            const sectionStartIndex: number = totalCount; // Start index of video within the current section
                                ...
                                return (
                                    <div 
                                        className={`w-full ${
                                            ...
                                            } cusor-pointer transition-all p-2`}
                                            key={item._id}
