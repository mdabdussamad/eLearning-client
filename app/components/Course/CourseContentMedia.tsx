    ...
    <div className="w-[95%] 800px:w-[86%] py-4 m-auto">
      ...
      <div className="w-full p-4 flex items-center justify-center bg-slate-500 bg-opacity-20 backdrop-blur shadow-[bg-slate-700] rounded shadow-inner">
        {["Overview", "Resources", "Q&A", "Reviews"].map((text, index) => (
          <h5
            key={index}
            className={`800px:text-[20px] cusrsor-pointer ${
              activeBar === index
                ? "text-red-500"
          ...
          <div className="flex w-full">
            <Image
              src={
                user.avatar
                  ? user.avatar.url
                  : "https://res.cloudinary.com/dbdsquim5/image/upload/v1726082334/avatars/hmjruelyrdr2uzja1jjw.jpg"
              }
              width={50}
              height={50}
              alt=""
            ...
            <textarea
              ...
              className="outline-none bg-transparent ml-3 border border-[#ffffff57] 800px:w-full p-2 rounded w-[90%] text-[18px] font-Poppins"
            ></textarea>
          </div>
        ...
        <div className="w-full">
          <>
                ...
                <div className="flex w-full">
                  ...
                  <div className="w-full">
                    ...
                    <textarea
                      ...
                      className="outtline-none bg-transparent 800px:ml-3 border border-[#ffffff57] w-[95%] 800px:w-full p-2 rounded text-[18px] font-Poppins"
                    ></textarea>
                  </div>
                </div>
                <div className="w-full flex justify-end">
            ...
            <div className="w-full h-[1px] bg-[#ffffff3b]">
              <div className="w-full">
                {(course?.review && [...course.reviews].reverse())?.map(
                    ...
                    >
                      <div className="w-full flex">
                        ...
                        <div className="ml-2">
                          ...
                          <p>{item.comment}</p>
                          <small className="text-[#0000009c] dark:text-[#ffffff83]">
      ...
      <div className="my-4">
        <div className="flex mb-2">
          ...
          <div className="pl-3 text-black dark:text-white">
            ...
            <p>{item?.question}</p>
            <small className="text-[#ffffffb8] dark:text-[#ffffff83]">
        ...
        <div className="w-full flex">
          <span
            className="800px:pl-16 text-[#ffffffb8] dark:text-[#ffffff83] cursor-pointer mr-2"
            onClick={() => {
          ...
          />
          <span className="pl-1 mt-[-4px] cursor-pointer text-[#ffffffb8] dark:text-[#ffffff83]">
            {item.questionReplies.length}
          </span>
        </div>
        {/* {replyActive && questionId === item._id && ( */}
        
        {replyActive && setQuestionId === item._id && (
          <>
              ...
              <div className="w-full flex relative dark:text-white text-black">
                <input
                  ...
                  className={`block 800px:ml-12 mt-2 outline-none bg-transparent border-b border-[#00000027] dark:text-white text-black dark:border-[#fff] p-[5px] w-[95%] ${
                    answer === "" ||
                    (answerCreationLoading && "curse-not-allowed")
                  }`}
                />
                <button
                  type="submit"
