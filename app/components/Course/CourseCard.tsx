...
//         <div className="w-full min-h-[35vh] dark:bg-slate-500 dark:bg-opacity-20 backdro-blur border dark:border-[#ffffff1d] border-[#00000015] dark:shadow-[bg-slate-700] rounded-lg p-3 shadow-sm dark:shadow-inner ">
//             <Image
      ...
      <div className="w-full min-h-[35vh] dark:bg-slate-500 dark:bg-opacity-20 backdrop-blur border dark:border-[#ffffff1d] border-[#00000015] dark:shadow-[bg-slate-700] rounded-lg p-3 shadow-sm dark:shadow-inner ">
        ...
        {item?.thumbnail?.url ? (
          ...
          <div className="w-full h-[300px] flex items-center justify-center bg-gray-300 rounded">
            <span className="text-black dark:text-[#fff]">No image available</span>
          </div>
        )}
