    ...
    <div className="w-[90%] m-auto py-5 mb-5">
      <div className="w-full relative">
        ...
        <div className="flex items-center w-80">
          <div
            className={`${styles.button} w-[120px] my-3 font-Poppins !bg-[crimson] cusor-not-allowed`}
          >
        ...
        <p className="pb-1 dark:text-white text-black">. Sourse code included</p>
        ...
        <p className="pb-1 800px:pb-1 dark:text-white text-black">. Premium Support</p>
      </div>
