...
const AllUsers: FC<Props> = ({ isTeam }) => {
  ...
  const [deleteUser, { isSuccess: deleteSuccess, error: deleteError }] = useDeleteUserMutation({});
   ...
   // Logging data to inspect the structure
   useEffect(() => {
            ...
            >
              <Box className="absolute top-[50%] left-[50%] -translate-x-1/2 -translate-y-1/2 w-[450px] bg-white dark:bg-slate-900 rounded-[8px] shadow p-4 outline-none">
                ...
                <div className="mt-4">
                  ...
                  />
                  <select name="" className={`${styles.input} !mt-6`}>
                    <option value="admin" className="dark:bg-slate-600 bg-white dark:text-white text-black">Admin</option>
                    <option value="user" className="dark:bg-slate-600 bg-white dark:text-white text-black">User</option>
                  </select>
                  <br />
                  <div
            ...
            >
              <Box className="absolute top-[50%] left-[50%] -translate-x-1/2 -translate-y-1/2 w-[450px] bg-white dark:bg-slate-900 rounded-[8px] shadow p-4 outline-none">
                ...
                <div className="flex w-full items-center justify-between mb-6 mt-4">
                  ...
                  <div
                    className={`${styles.button} !w-[120px] bg-[#d63f3f]`}
