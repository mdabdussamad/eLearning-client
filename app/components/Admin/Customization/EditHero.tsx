...
const EditHero: FC<Props> = (props: Props) => {
  ...
  //         <div className="absolute top-[100px] 1000px:top-[unset] 1500px:h-[700px] 1500px:w-[700px] 1100px:h-[500px] 1100px:w-[500px] h-[50vh] w-[50vh] hero_animation runded-[50%] 1100px-left-[18rem] 1500px:left-[21rem] ">
  ...
  //                 placeholder="We have 40k+ Online course & 500k+ Online registered student. Find your desired Courses from them."
  ...
  //             className={`${
  //                 styles.button
  //                 } !w-[100px] !min-h-[140px] dark:text-white text-black bg-[#cccccc34]
  //                 ${
